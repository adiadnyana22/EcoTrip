        ...
        <div class="max-h-screen max-w-full bg-[#F4F4F4] pl-24 pt-12 pr-16 pb-16 overflow-auto">
            <div>
                ...
                <div class="bg-white rounded-lg shadow mb-5 px-6 py-4">
                    ...
                    <a href="{{ route('exploreSuccess') }}" class="rounded bg-primary px-4 py-3 text-center text-white block w-full mb-2 mt-8 border border-primary transition hover:text-primary hover:bg-transparent">Saya Sudah Bayar</a>
                </div>
            </div>
        </div>
    </section>

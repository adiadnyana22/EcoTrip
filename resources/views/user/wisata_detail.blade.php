                ...
                <div class="basis-3/5">
                    <div class="pb-6">
                        <div class="flex items-center justify-between">
                            ...
                            @if(Auth::check())<a href="{{ route('toggleWisataWishlist', ['wisata_id' => $wisata->id]) }}" class="flex items-center gap-2 text-lg">@if($isWishlist) <i class='bx bxs-heart text-red-500 text-2xl'></i> - wishlist @else <i class='bx bx-heart text-gray text-2xl' ></i> + wishlist @endif</a>@endif
                        </div>
                        ...
                        <div id="deskripsi">
                            ...
                            <div class="pt-6 pb-2">
                                ...
                                <div class="text-xl">
                                    ...
                                    {{ $wisata->rating }} <span class="text-gray">({{ $wisata->order }} reviews)</span>
                                </div>
                                <ul class="my-5 flex flex-col gap-3">
                                    @foreach ($review as $r)
    ...
    <script>
        ...
        function app() {
            return {
                ...
                no_of_days: [],
                blankdays: [],
                weekendPrice: {{ $wisata->local_weekend_price }},
                weekdayPrice: {{ $wisata->local_price }},
                weekendForeignPrice: {{ $wisata->foreign_weekend_price }},
                weekdayForeignPrice: {{ $wisata->foreign_price }},
                isWeekend() {

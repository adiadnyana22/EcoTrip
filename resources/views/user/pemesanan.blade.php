        ...
        <div class="max-h-screen max-w-full bg-[#F4F4F4] pl-24 pt-12 pr-16 pb-16 overflow-auto">
            <form action="">
                ...
                <div class="bg-white rounded-lg shadow mb-5" x-data="{ open: false }">
                    <div class="flex justify-between items-center font-medium cursor-pointer px-6 py-4" @click="open = ! open"><span>Informasi Pemesan 1</span><i class='bx bx-chevron-down' ></i></div>
                    <div x-show="open" class="px-6 py-4">
                        <div class="mb-6">
                            ...
                            <input type="email" placeholder="email" class="rounded border border-gray/25 px-6 py-3 block w-full mt-1">
                        </div>
                        <div class="mb-6">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>Nama</label>
                            <input type="text" placeholder="nama" class="rounded border border-gray/25 px-6 py-3 block w-full mt-1">
                        </div>
                        <div class="mb-6">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>No Telepon</label>
                            <input type="text" placeholder="no telepon" class="rounded border border-gray/25 px-6 py-3 block w-full mt-1">
                        </div>
                        <div class="mb-6">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>Jenis Kelamin</label>
                            <div class="flex items-center gap-3 ml-1">
                                <input type="radio" name="gender"><label for="">Laki -laki</label>
                            </div>
                            <div class="flex items-center gap-3 ml-1">
                                <input type="radio" name="gender"><label for="">Perempuan</label>
                            </div>
                        </div>
                        <div class="mt-6 mb-2">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>Kewarganegaraan</label>
                            <select class="rounded border border-gray/25 px-6 py-3 block w-full mt-1">
                ...
                <div class="bg-white rounded-lg shadow mb-5" x-data="{ open: false }">
                    <div class="flex justify-between items-center font-medium cursor-pointer px-6 py-4" @click="open = ! open"><span>Informasi Pemesan 2</span><i class='bx bx-chevron-down' ></i></div>
                    <div x-show="open" class="px-6 py-4">
                        <div class="mb-6">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>E-mail</label>
                            <div class="text-sm text-gray">*tiket akan dikirimkan melalui alamat email</div>
                ...
                <div class="bg-white rounded-lg shadow mb-5" x-data="{ open: false }">
                    <div class="flex justify-between items-center font-medium cursor-pointer px-6 py-4" @click="open = ! open"><span>Informasi Pemesan 3</span><i class='bx bx-chevron-down' ></i></div>
                    <div x-show="open" class="px-6 py-4">
                        <div class="mb-6">
                            <label for="" class="font-medium"><span class="text-red-400">*</span>E-mail</label>
                            <div class="text-sm text-gray">*tiket akan dikirimkan melalui alamat email</div>

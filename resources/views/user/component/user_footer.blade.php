    ...
    <div class="container mx-auto">
        <div class="flex justify-between item-center">
            <div class="flex justify-center items-center gap-6">
                <span>Eco Trip &copy; 2023</span>
                <div class="border border-gray/25 w-px h-full"></div>
            ...
            <div class="flex gap-3 items-center">
                ...
                <img src="{{ asset('assets/user/images/logo-appstore.png') }}" alt="App Store">
                <img src="{{ asset('assets/user/images/logo-googleplay.png') }}" alt="Google Play">
            </div>
        </div>
    </div>
</footer>

        ...
        <div class="container mx-auto flex">
            <div class="w-80 mt-12">
                <ul class="sticky top-10">
                    <li><a href="{{ route('profile') }}" class="block px-2 py-3 text-lg text-gray transition hover:text-black">Personal Info</a></li>
                    <li><a href="{{ route('voucher') }}" class="block px-2 py-3 text-lg transition hover:text-black">Voucher</a></li>
                ...
                <div class="py-3">
                    <div class="rounded-lg border border-gray/25 px-8 py-6 w-full flex items-center gap-8">
                        ...
                        <div>
                            ...
                            <p class="text-gray">{{ 'min Rp '.number_format($voucher->min_transaction_nominal) }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
